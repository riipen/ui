...
| <span class="prop-name">error</span> | <span class="prop-type">string</span> |  | An error to display below the input. |
...
| <span class="prop-name">warning</span> | <span class="prop-type">string</span> |  | A warning to display below the input. |
